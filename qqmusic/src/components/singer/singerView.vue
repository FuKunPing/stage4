    ...
    <Scroll class="listview" ref="listview">
        <ul>
            ...
            <li class="list-group" v-for='(singer,idx) in singerList' :key="idx">
                ...
                <!-- 歌手列表 -->
                <ul>
                    <li v-for='(item,i) in singer.singers' :key='i' class="list-group-item" @click="select(item)">
        ...
        <div class="list-shortcut">
            <ul>
                ...
                <li v-for='(key,i) in getIndex' :key="i" class="item" @click="scrollTo(i)">{{key}}</li>
            </ul>
        </div>
